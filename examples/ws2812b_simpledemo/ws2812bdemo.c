...
uint32_t WS2812BLEDCallback( int ledno )
{
	...
	return TweenHexColors( fire, ice, ((tween + ledno)>0)?255:0 ); // Where "tween" is a value from 0 ... 255
                                                                   //
    //TODO
    //WS2812BSimpleSend( GPIOD, 6, uint8_t * data, int len_in_bytes );
}
...
int main()
{
	...
	while(1)
	{
        ...
        WS2812BSimpleSend( GPIO_TypeDef * port, int pin, uint8_t * data, int len_in_bytes );
	}
}
